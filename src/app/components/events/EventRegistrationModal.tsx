...
export default function EventRegistrationModal({
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent
        className="max-w-md w-full p-0 rounded-none bg-white border-2 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] overflow-hidden"
        showCloseButton={true}
      >
        {step === "info" && (
          <div className="flex flex-col h-full">
            <div className="bg-primary p-8 border-b-4 border-black">
              <DialogHeader className="space-y-4">
                <DialogTitle className="text-3xl sm:text-3xl font-black tracking-tighter text-white uppercase leading-[0.8]">
                  REJOIGNEZ <br />
            ...
            <div className="p-8 space-y-6">
              <div className="space-y-4">
                <button
                  ...
                  className="w-full cursor-pointer h-14 bg-black text-white text-xs font-black uppercase tracking-[0.2em] hover:bg-primary transition-all duration-300 border-2 border-black"
                >
                  CRÉER UN COMPTE
                </button>
                ...
                <button
                  ...
                  className="w-full cursor-pointer h-14 bg-white text-black text-xs font-black uppercase tracking-[0.2em] border-2 border-black hover:bg-zinc-50 transition-all duration-300"
                >
                  J&apos;AI DÉJÀ UN COMPTE
                </button>
              </div>
            ...
            {/* Decorative corners */}
            <div className="absolute bottom-4 right-4 w-4 h-4 border-b-2 border-r-2 border-black/10"></div>
          </div>
        )}
        ...
        {step === "success" && (
          <div className="flex flex-col h-full">
            <div className="bg-black p-8 flex flex-col items-center justify-center border-b-4 border-black">
              <div className="w-16 h-16 bg-primary flex items-center justify-center mb-6 border-4 border-white animate-slide-up">
                <FaCheck className="w-8 h-8 text-white" />
              </div>
              <h2 className="text-3xl font-black uppercase tracking-tighter text-white text-center leading-none">
                INSCRIPTION <br />
            ...
            <div className="p-8 space-y-8 text-center">
              ...
              <div className="bg-zinc-50 border-2 border-zinc-200 p-6">
                <p className="text-[9px] font-bold uppercase tracking-[0.2em] text-zinc-600 leading-relaxed text-left italic">
                  UN EMAIL DE CONFIRMATION A ÉTÉ ENVOYÉ. VEUILLEZ CLIQUER SUR LE
                  LIEN POUR ACTIVER VOTRE COMPTE ET FINALISER L&apos;ACCÈS.
                </p>
              </div>
            ...
            {/* Decorative corner */}
            <div className="absolute bottom-4 left-4 w-4 h-4 border-b-2 border-l-2 border-black/10"></div>
          </div>
        )}
      </DialogContent>
    </Dialog>
