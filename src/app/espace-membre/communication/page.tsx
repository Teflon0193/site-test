    ...
    <div className="space-y-7">
      <section className="rounded-2xl bg-primary p-6 text-primary-foreground shadow-sm sm:p-8">
        <div className="flex items-start gap-4">
          <Radio className="mt-1 h-8 w-8 shrink-0" />
          ...
          <div>
            ...
            <p className="mt-2 max-w-2xl text-primary-foreground/90">
              Vérifiez les éléments destinés à la
              communication publique avant de
              transmettre le dossier au demandeur pour
              confirmation.
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Tous les comptes Communication voient cette
            même liste.
          </p>
        </div>
      ...
      <Card className="overflow-hidden">
        <CardContent className="p-0">
          {loading ? (
            ...
            <div className="p-12 text-center">
              <Radio className="mx-auto h-12 w-12 text-primary/40" />
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Les demandes validées par la Direction
                artistique apparaîtront ici.
              </p>
            </div>
          ) : (
                      ...
                      >
                        ...
                        <td className="px-5 py-4 text-right">
                          <Button asChild size="sm">
                            <Link
                              href={`/espace-membre/communication/demandes/${request.id}`}
                            >
